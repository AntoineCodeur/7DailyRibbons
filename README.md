...
-Fill the userdata.txt document as follow: <br />
  • In the first line : the name of your rom: paste what you copied just before <br />
  • In the second line : the language of your rom: write 'EN' for an english rom, 'FR' for a french rom. Do not add spaces or line breaks <br />
  • Save it and close it <br />
